-- Update admin_approve_verification to also send a notification
...
BEGIN
  ...
  VALUES (
    ...
    'verification',
    'ID Verified! 🛡️',
    'Your ID has been verified! You earned +' || verify_kp || ' KP' || CASE WHEN user_is_premium THEN ' (2x Plus bonus)' ELSE '' END || '. Your gold badge is now active.'
  );
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;

-- Update admin_reject_verification to also notify
